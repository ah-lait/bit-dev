<template>
  <div class="v-modal-wrapper">
    ...
    <transition name="v-modal-close">
      <button v-if="isOpen" ref="closeModal" class="v-modal__close" @click="toggleModal" :aria-label="ariaClose"></button>
    </transition>
    <transition name="v-modal-video">
      <div class="v-modal__player" aria-labelledby="v-modal__label" v-if="isOpen">
        <slot></slot>
      </div>
    </transition>

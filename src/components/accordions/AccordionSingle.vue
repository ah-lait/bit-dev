<template>
  <div class="bit-accordion">
    <div class="bit-accordion__item" :class="{ 'is-active active-background': itemOpen === id }">
      <button
        class="
      ...
      <div class="bit-accordion__item-body" :id="'sect-' + id" :ref="'accordion-item-' + id" role="region" :aria-labelledby="'accordion-title-' + id">
...
$accordion-transition: var(--bit-accordion-transition, 0.6s cubic-bezier(0.218, 0.63, 0.325, 1));
